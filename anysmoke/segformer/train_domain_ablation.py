...
def train():
    ...
    train_dir = "./AnySmokeDataset/AnySmokeSubTrain"
    val_dir   = "./AnySmokeDataset/AnySmokeTestBoreal"
    val_small_dir   = "./AnySmokeDataset/AnySmokeTestAuSmoke"
